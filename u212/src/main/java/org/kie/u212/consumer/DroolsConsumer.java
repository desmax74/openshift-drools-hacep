...
public class DroolsConsumer<T> implements EventConsumer, Callback {
    ...
    private DroolsBag externalContainer;

    public DroolsConsumer(String id, DroolsBag externalContainer) {
        this.id = id;
    ...
    public void changeTopic(String newTopic) {
        ...
        //kafkaConsumer.close();
        //kafkaConsumer.wakeup();//this cause exit from the loop and close the kafkaConsumer
        //kafkaConsumer = null;
        //kafkaConsumer = new KafkaConsumer<>(Config.getDefaultConfig());
